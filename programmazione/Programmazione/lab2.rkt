...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname lab2) (read-case-sensitive #t) (teachpacks ((lib "drawing.ss" "installed-teachpacks"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "drawing.ss" "installed-teachpacks")) #f)))
...
(glue-tiles (glue-tiles (shift-right smaller-tile 1.6) larger-tile ) (glue-tiles (shift-down(shift-right(half-turn larger-tile) 1.6) 0.8) (shift-down(shift-right (half-turn smaller-tile) 1.6) 4)))
