...
; funzione per trasformare la parte intera binaria in decimale
...
; funzione che individua la parte intera (tutto quello prima del punto)
(define parteIntera
(lambda (n)
  (if (= (string-length n) 0)
    ""
...
; funzione per trasformare la parte decimale binaria in decimale
...
; funzione che individua la parte decimale (tutto quello dopo del punto)
